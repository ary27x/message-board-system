...
export default function SportsBoard(props)
{
    const requiredData = [];
    ...
    {
        if (props.data[i].boards["sports"])
            requiredData.push(props.data[i])
    }
    var boardsData = [];
    ...
    return (
        <div className="message-wrapper">
           <div className="header-data"> /sports ⚽🏏🎾 
           </div>
            {
            requiredData.map((item , i) => <div key = {i} className="message">
